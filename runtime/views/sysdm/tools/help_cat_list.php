...
<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header">
            <div class="logo">
                <span class="logo-mini"><b>211gou</b></span>
                <span class="logo-lg"><b>211gou</b>后台管理</span>
            </div>
...
<div class="content">
	<table class="table">
		...
		<caption>
		<a class="btn btn-default" href='<?php echo IUrl::creatUrl("/tools/help_cat_edit");?>'>
		...
		<tbody>
			<?php foreach($items=Api::run('getHelpCategoryAll') as $key => $item){?>
			<tr>
				<td><?php echo isset($item['name'])?$item['name']:"";?></td>
				<td><?php echo $item['position_foot'] == 1 ? "是" : "否";?></td>
				<td><?php echo $item['position_left'] == 1 ? "是" : "否";?></td>
				<td>
					<a href='<?php echo IUrl::creatUrl("/tools/help_cat_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
					<a href='javascript:delModel({"link":"<?php echo IUrl::creatUrl("/tools/help_cat_del/id/".$item['id']."");?>"})'><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
