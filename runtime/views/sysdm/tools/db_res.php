	...
	<form action='<?php echo IUrl::creatUrl("/tools/backup_del");?>' method='post' name='resForm'>
		<table class="table list-table">
			...
			<caption>
                ...
                <a class="btn btn-default" onclick="delModel({'form':'resForm','link':'<?php echo IUrl::creatUrl("/tools/download_pack");?>','msg':'确定要打包下载么？'});">
			...
			<tbody>
				<?php foreach($items=$resList['system'] as $key => $item){?>
				<tr>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/tools/download/file/".$item['name']."");?>"><i class='operator fa fa-download'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/tools/backup_del/name/".$item['name']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
