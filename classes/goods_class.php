...
class goods_class
{
	...
	public function update($id,$postData)
	{
		...
		//赋值goods表默认数据
		$goodsUpdateData['name']         = $goodsUpdateData['name'];
	...
	*/
	public function del($goods_id)
	{
		...
		//删除与商品相关的操作表
		$goodsExtTable = array("category_extend_seller","category_extend","commend_goods","refer","products","notify_registry","group_price","goods_attribute","discussion","comment","favorite");
